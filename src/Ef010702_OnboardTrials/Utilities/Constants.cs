namespace Ef010702_OnboardTrials.Utilities;

public class Constants
{
    // All the following needs to be revisited.

    public const short OfficeNameLength = 64;

    public const short OfficeTypeLength = 32;

    public const short OfficeTimeZoneLength = 64;

    public const short OfficeEmailLength = 128;

    public const short OfficePhoneNumberLength = 32;
    ...
    public const short CompanyContactEmailLength = 128;
