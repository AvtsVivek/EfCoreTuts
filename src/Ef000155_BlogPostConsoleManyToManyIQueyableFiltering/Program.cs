...
using Ef000155_BlogPostConsoleManyToManyIQueyableFiltering;
...
public class Program
{
    public static void Main()
    {
        ...
        using (var context = new BlogsContext())
        {
            ...
            var queryable = context.Blogs
                .Include(blog => blog.Posts.Where(post => post.Title.Contains("6.0")))
                .ThenInclude(post => post.Tags.Where(tag => tag.Text.Contains("Ef")));
