...
{
  public static string DirPath { get; set; } = default!;

  static Examples()
  {
    DirPath = Directory.GetParent(Environment.CurrentDirectory)!.Parent!.Parent!.FullName;
  }

  public static void QueryFiltersBasicExample()
  {
    using (var db = new BloggingContext("diego", DirPath))
    {
      if (db.Database.EnsureCreated())
      {
        ...
        using (var andrewDb = new BloggingContext("andrew", DirPath))
        {
          andrewDb.Blogs.Add(
              new Blog
              {
  ...
  public static void QueryFiltersWithNavigationsExample()
  {
    using (var animalContext = new AnimalContext(DirPath))
    {
  ...
  public static void QueryFiltersWithRequiredNavigationExample()
  {
    using (var db = new FilteredBloggingContextRequired(DirPath))
    {
  ...
  public static void QueryFiltersUsingNavigationExample()
  {
    using (var db = new FilteredBloggingContextRequired(DirPath))
    {
      db.Database.EnsureDeleted();
